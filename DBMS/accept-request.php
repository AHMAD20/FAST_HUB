...
<body>
       <div id="wrapper">
              ...
              <div id="rrright-panel">  
                            ...
                            <input type="text" name="PersonID" placeholder="Enter Person ID">
                            <button type="submit" name="submit" value="submit">Accept Request</button>
                            </form>
<?php
		...
		if(mysqli_affected_rows($connectionStatus)==0)
				{
					...
					$result = mysqli_query($connectionStatus,$query);
						...
						if(mysqli_affected_rows($connectionStatus)!=0)
						{
							...
							$connectionStatus = connect_db();
							update($connectionStatus,$myid,$fid);
							$connectionStatus = connect_db();
							insert_data2($connectionStatus,$fid,$myid);
							echo "<br>friend request accept successfully ";
						}
								else 
								echo "<br>Already Friend request accepted";
