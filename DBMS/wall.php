...
<body>
    <!--   <div id="wrapper"> -->
              ...
              ?> 
              <div id="right-panel">
                    <form action="status-form.php" method="post" > 
                    <textarea name="box" rows="10" cols="30" placeholder="whats happening?"></textarea>
                    <button type="submit" name="submit" value="submit">Post</button><br><br><br>
                    <?php 
					...
					$query="select * from post as b where b.myid=$id OR (b.myid in (select friendid from friends where myid = $id and status = 'F'))  
                   ...
                   <div id="post">
                  <?php  echo $s[$i]."<br><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
